...
1. Search for commits in branches and sort by username or date.
...
- qt5. 
    - Run `where qmake` (Linux) or `which qmake` (Mac OS) to check whether there is qmake, if not, you need to install qt5.
    - Try to download a.
